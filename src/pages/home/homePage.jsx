...
const homePage = () => {
  return (
    ...
    <div className='checkprops'>
      ...
      <div className='allProperties'>
          <p className='xplore'>Find answers to common questions about Estatein's services, property listings, 
            and the real estate process. 
             We're here to provide clarity and<br></br> assist you every step of the way.</p>
      ...
      <h3>How do I search for properties on<br></br> Estatein?</h3>
          <p className='learnHow'>Learn how to use our user-friendly search tools<br></br>
          to find properties that match your criteria.</p>
          <button className='viewAlls1'> Read More</button>
      </div>
      <div className='qwertys'>
      <h3>What documents do I need to sell my<br></br> property through Estatein?</h3>
          <p className='learnHow'>Find out about the necessary documentation <br></br>
          for listing your property with us.</p>
          <button className='viewAlls1'> Read More</button>
      </div>
      <div className='qwertys'>
      <h3>How can I contact an Estatein agent?</h3>
          <p className='learnHows'>Discover the different ways you can get in touch<br></br>
           with our experienced agents.</p>
          <button className='viewAlls1'> Read More</button>
      </div>
      </div>
    </div>
    <div className='pages2'>
      ...
      <div className='allProperties'>
          <p className='xplore'>Your dream property is just a click away. Whether you're looking for a new home, 
          a strategic investment, or expert real estate advice,<br></br> Estatein is here to assist you every 
          step of the way. 
          Take the first step towards your real estate goals and 
          explore our available properties<br></br> or get in touch with our team for personalized assistance.</p>
